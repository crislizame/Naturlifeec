...
import net.grietainc.naturlife.PedidoproActivity;
import net.grietainc.naturlife.R;
import net.grietainc.naturlife.buscar.ConfirmarAdapter;
import net.grietainc.naturlife.buscar.PedidoAdapter;
import net.grietainc.naturlife.buscar.Productos;
import net.grietainc.naturlife.buscar.pedidos;
