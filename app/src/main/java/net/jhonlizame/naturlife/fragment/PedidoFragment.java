...
import net.jhonlizame.naturlife.ItemAdapter;
import net.jhonlizame.naturlife.PedidoproActivity;
import net.jhonlizame.naturlife.R;
import net.jhonlizame.naturlife.buscar.Item;
                        ...
                        if(response.length()>0){
                            try {
                                ...
                                if(compras.equals("0")){
                                    ...
                                    cp.setText(compras);
                                    cp.setTextColor(Color.parseColor("#cc0000"));
                                    validador = 0;
                                }
