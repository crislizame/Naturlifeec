package net.jhonlizame.naturlife.fragment;
...
import net.jhonlizame.naturlife.activity.AddCliente2Activity;
...
public class AddClienteFragment extends Fragment implements View.OnClickListener {
    ...
    public ArrayList<String> add2client;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_nextt:
                ...
                intent.putExtra("clitelef1", et_tel1.getText().toString());
                intent.putExtra("clitelef2", et_tel2.getText().toString());
                intent.putExtra("clitelef3", et_tel4.getText().toString());
                intent.putExtra("clitelmovil", et_tel5.getText().toString());
                intent.putExtra("tipcodigo", sp_tipo.getSelectedItem().toString());
                intent.putExtra("ciucodigo", sp_ciudad.getSelectedItem().toString());
                intent.putExtra("zoncodigo", sp_zona.getSelectedItem().toString());
                intent.putExtra("clisexo", sp_sexo.getSelectedItem().toString());
                intent.putExtra("cliecategoria", sp_cate.getSelectedItem().toString());
